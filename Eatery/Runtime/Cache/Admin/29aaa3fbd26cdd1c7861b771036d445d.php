...
<html>
	<head>
        ...
        <script src='/OrderFood/Public/tools/jquery/jquery.cookie.js'></script>
	...
	<!-- 第一个页面 也是首页面 当管理员进入时的默认页面-->
		<div data-role="page" id="index">
            ...
            <div >
                <audio id="audio_order" src=""  autoplay="autoplay" >
                </audio>
            </div>
				<div data-role="footer" data-theme="e" data-position='fixed' data-fullscreen="true">
			     <div data-role="navbar">
			      <ul>
			        ...
			        <li><a class="myinfo" href="./admin_my_info" data-ajax="false" data-icon="info">我的信息</a></li>
			      </ul>
			    </div>   
			  </div> 
		</div>
